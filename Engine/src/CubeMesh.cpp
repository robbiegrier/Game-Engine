...
namespace Azul
{
		...
		: Mesh(NUM_VERTS, NUM_INDICES)
	{
		...
		pVertexBufferTextureCoordinates = CreateVertexBuffer(sizeof(g_CubeVertices_texCoord), g_CubeVertices_texCoord);
		pVertexBufferNormal = CreateVertexBuffer(sizeof(g_CubeVertices_norm), g_CubeVertices_norm);
